// use flux_error::{filesystem, PIError, PIErrorCode, Span};
// use std::ops::Range;
...
// 		while self.ch().is_digit(base as u32) || self.ch() == '_' {
// 			self.next();
// 		}
// 	}
// }
...
// 	let mut arr = vec![];
// 	let mut eof_tok = Token::from(TokenKind::EOF, 0..0);
// 	while lex.ch() != '\0' {
// 		let res = lex.token();
// 		eof_tok.span = res.span.end..res.span.end;
// 		arr.push(res);
// 	}
// 	arr.push(eof_tok);
// 	(arr, errors)
