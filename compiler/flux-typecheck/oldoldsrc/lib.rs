...
// };
// use flux_error::{filesystem::FileId, FluxError, FluxErrorCode, FluxErrorReporting};
...
// 	err_reporting: &'a FluxErrorReporting,
...
// 	pub fn new(ast_map: &'a IndexMap<FileId, AST>, err_reporting: &'a FluxErrorReporting) -> Self {
// 		Self {
// 			ast_map,
// 			err_reporting,
// 			file_id: FileId(0),
...
// 	pub fn check(&mut self, ast_map: &'a mut IndexMap<FileId, AST>) -> Option<FluxError> {
...
// 	fn check_apply(&mut self, apply_block: &'a mut ApplyBlock) -> Option<FluxError> {
...
// 	fn check_fn(&mut self, f: &'a mut FnDecl) -> Option<FluxError> {
...
// 	fn get_type_of_var_in_cur_block(&self, name: &Spanned<Ident>) -> (&'a Expr, Option<FluxError>) {
...
// 				FluxErrorCode::TypecheckCouldNotGetTypeOfVar,
// 				vec![(
// 					format!("could not get type of variable `{}`", name.to_string()),
// 					name.span.clone(),
// 				)],
...
// use flux_error::{filesystem::FileId, FluxErrorReporting};
