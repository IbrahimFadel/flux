...
// use flux_error::{filesystem::FileId, FluxError, FluxErrorCode, FluxErrorReporting, Span};
...
// impl<'ctx> FnCtx<'ctx> {
// 	pub fn error(&self, msg: String, code: FluxErrorCode, labels: Vec<(String, Span)>) -> FluxError {
// 		FluxError::new(msg, code, labels)
// 	}

// 	fn get_type_of_var_in_cur_block(&self, name: &Spanned<Ident>) -> Result<&'ctx Expr, FluxError> {
...
use flux_ast::AST;
use flux_error::{filesystem::FileId, FluxError, FluxErrorReporting};
use indexmap::IndexMap;
