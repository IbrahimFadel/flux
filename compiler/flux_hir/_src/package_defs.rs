...
pub struct PackageDefs {
    pub modules: ArenaMap<ModuleID, ItemScope>,
...
impl PackageDefs {
    ...
    pub fn add_root_module(
        ...
        let module_data = ModuleData::root(module, module_name, file_id);
        let idx = self.module_tree.modules.alloc(module_data);
        self.modules.insert(idx, item_scope);
    ...
    pub fn add_module(
        ...
        let item_scope = self.create_item_scope(&module);
        let module_data = ModuleData::new(parent, module, module_name, file_id);
        let idx = self.module_tree.modules.alloc(module_data);
        self.modules.insert(idx, item_scope);
        idx
    }
    ...
    pub fn get_item_scope(&self, id: ModuleID) -> &ItemScope {
...
impl ModuleData {
    pub fn root(module: Module, name: Spur, file_id: FileId) -> Self {
        Self {
            parent: None,
    ...
    pub fn new(parent: ModuleID, module: Module, name: Spur, file_id: FileId) -> Self {
        Self {
            parent: Some(parent),
            children: HashMap::new(),
            module,
