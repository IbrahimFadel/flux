...
impl<'tenv> TChecker<'tenv> {
    ...
    pub fn does_type_implement_restrictions(
        ...
        for restriction in restrictions {
            if !self.does_type_implement_restriction(ty, restriction)?.0 {
    ...
    pub fn does_type_implement_restriction(
        &mut self,
        ty: TypeId,
    ...
    //     fn are_trait_restrictions_equal(&mut self, a: &TraitRestriction, b: &TraitRestriction) -> bool {
    //         if a.trait_id.inner.inner == b.trait_id.inner.inner {
    //             return false;
    //         }
    ...
    //                     self.tenv
    //                         .fmt_trait_restriction(restriction)
    //                         .file_span(restriction.trait_id.file_id, restriction.trait_id.span),
    //                 );
    //             }
    //         }
    ...
    //                     return (true, file_span);
    //                 }
    //             }
    //         }

    //         return (false, file_span);
    //     }
